...
def banner():
	clear()
	print("""
	.dP"Y8  GR   88b 88    db        88   88 88     88        db    88  88 
`Ybo."   dPYb   88Yb88   dPYb       88   88 88     88       dPYb   88  88 
o.`Y8b  dP__Yb  88 Y88  dP__Yb      Y8   8P 88  .o 88  .o  dP__Yb  888888 
8bodP' dP""""Yb 88  Y8 dP""""Yb     `YbodP' 88ood8 88ood8 dP""""Yb 88  88
┏━━━━━﷽━━━━━┓
 🕋   𝑬𝑰𝑫 𝑴𝑼𝑩𝑨𝑹𝑨𝑲 🌻
┗━━━━━﷽━━━━━┛
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Authur       \x1b[92;1m=>         \x1b[93;1m SANA ULLAH
\x1b[93;1m Whatsp       \x1b[92;1m=>        \x1b[93;1m018801+++++
\x1b[93;1m Github       \x1b[92;1m=>         \x1b[93;1m GREEN
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #SANA-ULLAH
	...
	if farhan in ['1','01']:
		...
		os.system("xdg-open https://youtu.be/en4-uLatbIY ")
		exit()
	else:
		os.system("https://youtu.be/en4-uLatbIY")
		exit()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [Khan-CP] %s|%s        '%(b,idf,pw))
					open('CP/'+cpc,'a').write(idf+'|'+pw+'\n')
					akun.append(idf+'|'+pw)
					cp+=1
				break
			elif "session_key" in resp.text and "EAAB" in resp.text:
				print('\r%s [Khan-ok] %s|%s        '%(h,idf,pw))
...
if __name__=='__main__':
	...
	os.system("xdg-open https://www.facebook.com/tamim.is.brand")
	menu()
